...
- timeline[]: per-second {t, scroll_y, scores_zscored, visible_unit_ids}.
  Each row corresponds to ONE wall-clock second (1Hz, t=0..len-1) and
  aligns 1:1 to the `frame_at_<t>s` images. Units listed at second t
  were in the viewport when the brain was reacting. TRIBE has already
  compensated for hemodynamic lag.
